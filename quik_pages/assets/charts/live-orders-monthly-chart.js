...
// Class definition
var LiveOrdersMonthlyChart = function () {    
    var initChart = function () {
        // Get all elements with the class 'live_orders_bar_chart'
        var elements = document.getElementsByClassName("live_orders_monthly_chart");
        ...
        const generateRandomData = () => Array.from({ length: 30 }, () => Math.floor(Math.random() * 50) + 10);
